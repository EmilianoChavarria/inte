...
function SidebarComponent() {
    ...
    return (
        <Sidebar aria-label="Sidebar with logo branding example" className="bg-gray-800 h-screen border-t border-r border-gray-200">
            <Sidebar.Logo href="/homeAdmin" img="https://cdn-icons-png.flaticon.com/512/3009/3009710.png" imgAlt="hameto logo">
            ...
            <Sidebar.Items>
                ...
                <Sidebar.ItemGroup>
                    <Sidebar.Item href="/homeAdmin" icon={FaHotel}>Gestión de Hoteles</Sidebar.Item>
                </Sidebar.ItemGroup>
                {/* <Sidebar.ItemGroup>
